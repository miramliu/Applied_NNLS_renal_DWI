            ...
            if compartmaxidx == minidx % if max peak is also closest to diffusion
                ...
                if CompartmentDiffusions(larger_idx) > 0.8  
                    ...
                    if CompartmentDiffusions(smaller_idx) > 5 %if the other one is not tissue diffusion, the larger one is (even if < .8)
                        ...
                        Sortedmoments = [0, 0, firstmoments(larger_idx), firstmoments(smaller_idx)];
                        ...
                        Sortedmoments = [0, 0, firstmoments(smaller_idx), firstmoments(larger_idx)];
            ...
            if SortingDone == 0
                ...
                if CompartmentDiffusions(max_idx) > CompartmentDiffusions(tissue_idx)
                    ...
                    if CompartmentDiffusions(max_idx) > 50 
                        ...
                        Sortedmoments = [firstmoments(max_idx), 0, firstmoments(tissue_idx), 0];
                        ...
                        Sortedmoments = [0, firstmoments(max_idx), firstmoments(tissue_idx), 0];
                    ...
                    Sortedmoments = [0, 0, firstmoments(tissue_idx),  firstmoments(max_idx)];
            ...
            if compartmaxidx == minidx % if largest peak is also closest to diffusion
                        ...
                        if any(CompartmentDiffusions <.8) && any(CompartmentDiffusions > 5) %if there's one peak above aand one peak below tissue range
                            ...
                            if CompartmentDiffusions(min_idx) < CompartmentDiffusions(max_idx) %if min is less than max, min is the fibrosis
                                ...
                                if CompartmentDiffusions(max_idx) > 50 %if the max is over 50, it's blood
                                    ...
                                    Sortedmoments = [firstmoments(max_idx), 0, firstmoments(tissue_idx),firstmoments(min_idx)];
                                    ...
                                    Sortedmoments = [0, firstmoments(max_idx), firstmoments(tissue_idx),firstmoments(min_idx)];
                                ...
                                if CompartmentDiffusions(min_idx) > 50 %if the max is over 50, it's blood
                                    ...
                                    Sortedmoments = [firstmoments(min_idx), 0, firstmoments(tissue_idx),firstmoments(max_idx)];
                                    ...
                                    Sortedmoments = [0,firstmoments(min_idx), firstmoments(tissue_idx),firstmoments(max_idx)];
                            ...
                            if CompartmentDiffusions(min_idx) < .8 %if both peaks are smaller than the tissue range (then slow tubule, NO BLOOD)
                                if CompartmentDiffusions(max_idx) > CompartmentDiffusions(min_idx) %if max is the one in the range then 
                                    ...
                                    Sortedmoments = [0,firstmoments(max_idx), firstmoments(min_idx),firstmoments(middle_idx)];
                                    ...
                                    Sortedmoments = [0,firstmoments(middle_idx), firstmoments(min_idx),firstmoments(max_idx)];
                                ...
                                if CompartmentDiffusions(max_idx)>CompartmentDiffusions(middle_idx)
                                    ...
                                    Sortedmoments = [firstmoments(max_idx), firstmoments(min_idx),firstmoments(middle_idx), 0];
                                    ...
                                    Sortedmoments = [firstmoments(middle_idx), firstmoments(min_idx),firstmoments(max_idx), 0];
                ...
                if SortingDone ==0 
                    ...
                    if CompartmentDiffusions(tissue_idx) == min(nonzeros(CompartmentDiffusions))
                        ...
                        Sortedmoments = [firstmoments(max_idx), firstmoments(middle_idx),firstmoments(tissue_idx), 0];
                    ...
                    elseif CompartmentDiffusions(tissue_idx) == max(nonzeros(CompartmentDiffusions))
                        if CompartmentFractions(min_idx)/CompartmentFractions(middle_idx) > 1.5 % if middle is within 1.5 of tissue (min) in terms of size
                            ...
                            Sortedmoments = [0, firstmoments(min_idx), firstmoments(middle_idx),firstmoments(max_idx)];
                            ...
                            Sortedmoments = [0, 0, firstmoments(tissue_idx),firstmoments(max_idx)+firstmoments(middle_idx)];
                        ...
                        if CompartmentDiffusions(max_idx) > CompartmentDiffusions(tissue_idx) 
                            ...
                            if CompartmentDiffusions(max_idx) > 50 
                                ...
                                Sortedmoments = [firstmoments(max_idx), 0, firstmoments(tissue_idx),firstmoments(middle_idx)];
                                ...
                                Sortedmoments = [0, firstmoments(max_idx), firstmoments(tissue_idx),firstmoments(middle_idx)];
                            ...
                            if CompartmentDiffusions(middle_idx) > 50 
                                ...
                                Sortedmoments = [firstmoments(middle_idx), 0, firstmoments(tissue_idx),firstmoments(max_idx)];
                                ...
                                Sortedmoments = [0, firstmoments(middle_idx), firstmoments(tissue_idx),firstmoments(max_idx)];
                ...
                if SortingDone ==0 
                    ...
                    if CompartmentDiffusions(tissue_idx) == min(nonzeros(CompartmentDiffusions))
                        ...
                        Sortedmoments = [ firstmoments(other1_idx), firstmoments(other2_idx),firstmoments(tissue_idx), 0];
                    ...
                    elseif CompartmentDiffusions(tissue_idx) == max(nonzeros(CompartmentDiffusions))
                        if CompartmentFractions(tissue_idx)/CompartmentFractions(other2_idx) > 1.5 % if middle is within 1.5 of tissue (min) in terms of size
                            ...
                            Sortedmoments = [0, firstmoments(tissue_idx), firstmoments(other2_idx),firstmoments(other1_idx)];
                            ...
                            Sortedmoments = [0, 0, firstmoments(tissue_idx),firstmoments(other1_idx)+ firstmoments(other2_idx)];
                        ...
                        if CompartmentDiffusions(other1_idx) > CompartmentDiffusions(tissue_idx) 
                            ...
                            if CompartmentDiffusions(other1_idx) > 50 
                                ...
                                Sortedmoments = [firstmoments(other1_idx), 0,firstmoments(tissue_idx), firstmoments(other2_idx)];
                                ...
                                Sortedmoments = [0, firstmoments(other1_idx), firstmoments(tissue_idx), firstmoments(other2_idx)];
                            ...
                            if CompartmentDiffusions(other2_idx) > 50 
                                ...
                                Sortedmoments = [ firstmoments(other2_idx), 0, firstmoments(tissue_idx), firstmoments(other1_idx)];
                                ...
                                Sortedmoments = [0, firstmoments(other2_idx), firstmoments(tissue_idx), firstmoments(other1_idx)];
