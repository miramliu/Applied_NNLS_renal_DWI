...
[~,~,~,~,~] = RunNNLS_ML_Lesion('P004','retest_Lesion1');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P005','Lesion1');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P006','Lesion1');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P007','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P008','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P009','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P010','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P011','LK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P012','LK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P013','LK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P014','LK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P015','LK_Lesion');
...
[~,~,~,~,~] = RunNNLS_ML_Lesion('P024','LK_Lesion');
...
[~,~,~,~,~] = RunNNLS_ML_Lesion('P031','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P032','RK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P033','RK_Lesion1');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P034','RK_Lesion1');
...
[~,~,~,~,~] = RunNNLS_ML_Lesion('P043','LK_Lesion');
[~,~,~,~,~] = RunNNLS_ML_Lesion('P044','RK_Lesion');